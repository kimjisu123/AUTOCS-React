            ...
            <div className="mainContainer">
                ...
                <div className="rightContainer">
                    <div className="content">
                        <div className="wrap">
                            <div className="empinfo-image">
                                <div className="info-title">
                                    <h1>사원 정보</h1>
                                </div>
                                <div>
                                    <img src="/main/img/emp.jpg" alt="" className="empinfo-img"/>
                                    <button className="imgbutton" type="submit">바꾸기</button>
                                </div>
                                <br/>
                                    <span style="color: white; text-align:center">가로200 세로 200<br/>이미지를 넣어주세요</span>
                            ...
                            <div className="infoinput">
                                <form id="infoform" action="/mypage/changeInfo" method="post">
                                    <div className="sections">
                                        <div className="section1">
                                            <div className=" empInfo empId">
